    ...
    () => [
      ...
      },
      {
        ...
        subContent: (
          <div className="flex items-center text-xs font-bold text-slate-800 pt-1">
            <i className="fa-solid fa-circle-check text-orange-500 mr-2 text-sm" />
            <span>{detailText.s2_sub1 || "บริการขนส่งสินค้าแบบถึงมือผู้รับ Door to door"}</span>
          </div>
        ),
      },
      {
      ...
      },
      {
        ...
        subContent: (
          <div className="flex items-center text-xs font-bold text-slate-800 pt-1">
            <i className="fa-solid fa-circle-check text-orange-500 mr-2 text-sm" />
            <span>{lang === "en" ? "24/7 Global Tracking & Monitoring System" : "ระบบดูแลและติดตามสินค้าตลอด 24 ชั่วโมง"}</span>
          </div>
        ),
      },
      {
    ...
    <div className="relative overflow-x-hidden bg-slate-100 text-slate-800">
      ...
      <section id="contact-card" className="py-24 max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          {/* 🎴 Business Card 1: ผู้บริหารท่านที่ 1 */}
                ...
                <div className="w-full md:w-7/12 space-y-4 text-left flex flex-col justify-center">
                  ...
                  <div className="space-y-2.5 pt-2 text-xs text-slate-600 font-medium">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <a href={`tel:${isMounted ? detailText.c1_phone : ""}`} className="hover:text-orange-600 transition-colors">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <a href={`mailto:${isMounted ? detailText.c1_mail : ""}`} className="hover:text-orange-600 transition-colors line-clamp-1">
          ...
          {/* 🎴 Business Card 2: ผู้บริหารท่านที่ 2 */}
                ...
                <div className="w-full md:w-7/12 space-y-4 text-left flex flex-col justify-center">
                  ...
                  <div className="space-y-2.5 pt-2 text-xs text-slate-600 font-medium">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <a href={`tel:${isMounted ? detailText.c2_phone : ""}`} className="hover:text-orange-600 transition-colors">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <a href={`mailto:${isMounted ? detailText.c2_mail : ""}`} className="hover:text-orange-600 transition-colors line-clamp-1">
