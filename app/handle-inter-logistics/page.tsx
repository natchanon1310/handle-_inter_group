...
export default function HandleInterLogisticsPage() {
  ...
  // 📦 ข้อมูลบริการ 5 ด้าน ดึงจาก dictionary ครบถ้วน
    ...
    () => [
      {
        ...
        title: detailText.s1_title || "Ocean Freight Services",
      ...
      },
      {
        ...
        tabTitle: detailText.s3_tab || "LCL Consolidation",
        tag: detailText.s3_tag || "CORE SERVICE 03 // LCL SERVICE",
        title: detailText.s3_title || "LCL Cargo Consolidation",
      ...
      {
        id: "trucking-fleet",
        tabTitle: detailText.s4_tab || "Land Transport",
        tag: detailText.s4_tag || "CORE SERVICE 04 // LAND TRANSPORT",
        title: detailText.s4_title || "Land Transportation",
      ...
      },
      {
        ...
        tabTitle: detailText.s5_tab || "Customs Clearance",
        tag: detailText.s5_tag || "CORE SERVICE 05 // CUSTOMS CLEARANCE",
        title: detailText.s5_title || "Customs Clearance & Brokerage",
        subtitle: detailText.s5_sub || "",
        desc: detailText.s5_desc || "",
        items: detailText.s5_items || [],
        icon: "📑",
      ...
      >
        <div className="text-center max-w-2xl mx-auto space-y-2 mb-8">
          ...
          <h2 className="text-2xl sm:text-4xl font-black tracking-tight text-white">
            {detailText.catalogTitle || "Handle Inter Logistics Catalog"}
          </h2>
          ...
          >
            ...
            <h2 className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tight text-stone-900 leading-[1.08]">
              ...
              <span className="bg-gradient-to-r from-amber-700 via-orange-600 to-amber-600 bg-clip-text text-transparent">
                {lang === "en" ? "TEAM WORK" : "การทำงานเป็นทีม"}
              </span>
            </h2>
          ...
          <ScrollCardReveal direction="up">
            <div className="text-center space-y-4 max-w-3xl mx-auto">
              ...
              <h3 className="font-black text-stone-900 text-3xl sm:text-5xl tracking-tight">
                {isMounted && (detailText.heroTitle || (lang === "en" ? "Handle Inter Logistics Co., Ltd." : "บริษัท แฮนเดิล อินเตอร์ โลจิสติกส์ จํากัด"))}
              </h3>
                    ...
                    <div className="space-y-3 pt-2 text-xs sm:text-sm text-stone-600 font-medium">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="line-clamp-1 text-stone-700">
                          {detailText.contactFleetHub || (lang === "en" ? "Bangkok & ASEAN Logistics Fleet Hub" : "กรุงเทพฯ และศูนย์ฟลีตขนส่งครอบคลุมอาเซียน")}
                        </span>
                      </div>
