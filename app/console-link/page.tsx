...
export default function ConsoleLinkPage() {
  ...
  // 📦 ข้อมูลบริการครบทั้ง 5 ด้าน ดึงตรงจาก Dictionary ตามภาษาที่เลือก
                  ...
                  >
                    ...
                    <div className="relative z-10 space-y-4 text-left">
                      <div className="bg-white px-3 py-1 rounded-md inline-block shadow-md">
                        ...
                        <div className="text-[8px] font-mono font-bold text-slate-700 tracking-tight">TOTAL INTEGRATED FREIGHT</div>
                      </div>
                      ...
                      <div className="relative w-full h-52 sm:h-56 rounded-xl overflow-hidden shadow-2xl border border-white/20">
                        ...
                        <div className="absolute bottom-3 left-3 text-left">
                          <span className="text-[10px] font-mono text-sky-300 uppercase tracking-widest block font-bold">
                            ONE STOP TOTAL FREIGHT FORWARDER
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-6 sm:p-8 md:p-10 flex flex-col justify-between text-left border-b md:border-b-0 md:border-r border-slate-200 relative bg-gradient-to-b from-white to-slate-50">
                      <div className="space-y-4">
                        ...
                        <p className="text-slate-700 text-xs sm:text-sm leading-relaxed font-normal pt-1">
                          {lang === "en"
                            ? "We provide comprehensive international freight forwarding and LCL consolidation services—fast, safe, and punctual."
                            : "เราให้บริการรับจัดการขนส่งสินค้าระหว่างประเทศและบริการรวมตู้สินค้า LCL ครบวงจร รวดเร็ว ปลอดภัย และตรงต่อเวลา"}
                        </p>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-1">
                          <h4 className="font-bold text-xs sm:text-sm text-slate-900 flex items-center">
                            ...
                            {detailText.s1_title || (lang === "en" ? "Ocean Freight (FCL/LCL)" : "ขนส่งสินค้าทางทะเล (FCL/LCL)")}
                          </h4>
                          <p className="text-[11px] sm:text-xs text-slate-600 pl-4 leading-relaxed font-light">
                            {lang === "en"
                              ? "Professional ocean logistics with solid global routes across Mediterranean, Europe, and Asia."
                              : "บริการอย่างมืออาชีพด้วยทีมงานคุณภาพ พร้อมเครือข่ายครอบคลุมทั่วทุกเส้นทาง"}
                          </p>
                        </div>
                        ...
                        <div className="space-y-1">
                          <h4 className="font-bold text-xs sm:text-sm text-slate-900 flex items-center">
                            <span className="w-2 h-2 rounded-full bg-blue-900 mr-2 shrink-0" />
                            {detailText.s2_title || (lang === "en" ? "Air Freight Services" : "ขนส่งสินค้าทางอากาศ")}
                          </h4>
                          <p className="text-[11px] sm:text-xs text-slate-600 pl-4 leading-relaxed font-light">
                            {detailText.s2_sub1 || (lang === "en" ? "Door to door delivery (DDU/DDP/FCA/Ex-work)" : "บริการแบบถึงมือผู้รับ Door to door ครอบคลุมทั่วโลก")}
                          </p>
                        </div>
                        ...
                        <div className="space-y-1">
                          <h4 className="font-bold text-xs sm:text-sm text-slate-900 flex items-center">
                            <span className="w-2 h-2 rounded-full bg-blue-900 mr-2 shrink-0" />
                            {detailText.s4_title || (lang === "en" ? "Customs Clearance" : "ดำเนินการพิธีการศุลกากร")}
                          </h4>
                          <p className="text-[11px] sm:text-xs text-slate-600 pl-4 leading-relaxed font-light">
                            {lang === "en"
                              ? "Dedicated customs border processing with precision and regulatory efficiency."
                              : "พร้อมให้บริการทุกขั้นตอนของการเดินพิธีการผ่านแดนทั้งทางเรือและทางอากาศ"}
                          </p>
                        </div>
                      </div>
